...
import { buscarPorAcao } from '../../../../controllers/filmControllers'; //Importamos a função 'buscarPorAcao' que foi criada no arquivo que concentra todas as funções de filtro do projeto Filmes, a 'controllers.ts'.

...
import { filtrarPorTitulo } from '../../../../controllers/filmControllers'; //Importamos a função 'filtrarPorTitulo' que foi criada no arquivo que concentra todas as funções de filtro do projeto Filmes, a 'controllers.ts'.
...
export default async function handler(req: NextApiRequest, res: NextApiResponse) {
    ...
    if(req.method === 'GET') { //Se for um 'get'. Usamos esse método pois mesmo sendo uma busca, mas é uma 'leitura'.
        return filtrarPorTitulo(req, res);
    }
